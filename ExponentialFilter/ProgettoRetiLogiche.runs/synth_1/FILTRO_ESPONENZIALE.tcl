...
synth_design -top FILTRO_ESPONENZIALE -part xc7k70tfbv676-1
...
write_checkpoint -force -noxdef FILTRO_ESPONENZIALE.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file FILTRO_ESPONENZIALE_utilization_synth.rpt -pb FILTRO_ESPONENZIALE_utilization_synth.pb"  } 
